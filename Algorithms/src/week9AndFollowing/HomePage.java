...
public class HomePage extends JFrame {
	...
	public void delete(String place,String from) throws IOException {
		try {
			...
			if(flag==0) {
				...
				try {	
					FileWriter fstream = new FileWriter("C:/Users/vbaral/git/repository2/Algorithms/src/week9AndFollowing/location_details.csv");
	...
	public void insert(String place,String distance,String from) throws IOException {
		...
		try {		
			//File dir = new File("C:/Users/vbaral/git/repository2/Algorithms/src/week9AndFollowing/location_details.csv");
			...
			FileWriter fstream = new FileWriter("C:/Users/vbaral/git/repository2/Algorithms/src/week9AndFollowing/location_details.csv", true);
			BufferedWriter out = new BufferedWriter(fstream);
	...
	public HomePage() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\vbaral\\git\\repository2\\Algorithms\\Img\\menuIcon 1.png"));
		...
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\vbaral\\git\\repository2\\Algorithms\\Img\\menuIcon 2.png"));
		lblNewLabel_3.setBounds(290, 0, 178, 230);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_5 = new JLabel("New label");
		lblNewLabel_5.setIcon(new ImageIcon("C:\\Users\\vbaral\\git\\repository2\\Algorithms\\Img\\menuIcon 3.png"));
		lblNewLabel_5.setBounds(639, 11, 178, 200);
		contentPane.add(lblNewLabel_5);
		
		JLabel lblNewLabel_6 = new JLabel("");
		lblNewLabel_6.setIcon(new ImageIcon("C:\\Users\\vbaral\\git\\repository2\\Algorithms\\Img\\menuIcon 4.png"));
